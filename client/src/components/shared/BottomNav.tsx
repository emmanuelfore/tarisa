  ...
  return (
    <div className="bg-white border-t border-gray-100 pb-safe px-6 h-20 flex justify-between items-start shadow-[0_-4px_20px_rgba(0,0,0,0.03)] backdrop-blur-lg bg-white/95">
      <Link href="/citizen/home">
        <a className={`flex flex-col items-center justify-center pt-3 gap-1 w-12 ${isActive("/citizen/home") || isActive("/") ? "text-primary" : "text-gray-400"}`}>
      ...
      <Link href="/citizen/map">
        <a className={`flex flex-col items-center justify-center pt-3 gap-1 w-12 ${isActive("/citizen/map") ? "text-primary" : "text-gray-400"}`}>
      ...
      <Link href="/citizen/report">
        <a className="flex flex-col items-center justify-center -mt-5">
      ...
      <Link href="/citizen/credits">
        <a className={`flex flex-col items-center justify-center pt-3 gap-1 w-12 ${isActive("/citizen/credits") ? "text-primary" : "text-gray-400"}`}>
      ...
      <Link href="/citizen/profile">
        <a className={`flex flex-col items-center justify-center pt-3 gap-1 w-12 ${isActive("/citizen/profile") ? "text-primary" : "text-gray-400"}`}>
