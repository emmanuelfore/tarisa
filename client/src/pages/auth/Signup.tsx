      ...
      <div className="px-6 py-6">
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          <div className="space-y-2">
            ...
            <Input id="fullname" placeholder="e.g. Tatenda Phiri" required />
          </div>

          <div className="space-y-2">
            <Label htmlFor="national_id">National ID Number</Label>
            <Input id="national_id" placeholder="63-XXXXXXX X XX" required className="font-mono" />
          ...
          <div className="space-y-2">
            ...
            <Select required>
              ...
              <SelectContent>
                <SelectItem value="ward7">Ward 7 - Avondale</SelectItem>
                <SelectItem value="ward6">Ward 6 - Avenues</SelectItem>
                <SelectItem value="ward1">Ward 1 - Harare Central</SelectItem>
                <SelectItem value="ward41">Ward 41 - Marlborough</SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              <Input id="phone" placeholder="77 123 4567" type="tel" required />
            </div>
          </div>
          ...
          <div className="flex items-start gap-2 pt-2">
            ...
            <Label htmlFor="terms" className="text-xs text-gray-500 font-normal leading-tight">
              I agree to the <span className="text-primary">Terms of Service</span> and verify that I am a resident of the selected ward.
            </Label>
          </div>
